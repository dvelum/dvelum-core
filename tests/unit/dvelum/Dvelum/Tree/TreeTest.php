...
class TreeTest extends TestCase
{
    ...
    {
        $tree = new Tree();
        $item1 = ['id' => 1, 'text' => 'text'];
        $tree->addItem(1, 0, $item1);

        $item2 = ['id' => 2, 'text' => 'text'];

        $this->assertTrue($tree->updateItem(1, $item2));
        $this->assertFalse($tree->updateItem(4, $item2));

        $this->assertEquals($tree->getItemData(1), $item2);
    }
    ...
    public function testGetItem(): void
    {
        ...
        $this->assertTrue(is_object($itemResult));
    ...
    public function testGetChildsR(): void
    {
        $tree = new Tree();
    ...
    public function testSortChilds(): void
    {
        $tree = new Tree();
    ...
    public function testGetChilds(): void
    {
        ...
        $this->assertEquals($children[0]['data'], [100]);
        $this->assertEquals($children[1]['data'], [200]);
    }
    ...
    public function testChangeParent(): void
    {
        ...
        $tree->addItem(1, 0, ['item1']);
        $tree->addItem(2, 1, [100]);
        $tree->addItem(3, 2, [200]);
        $tree->addItem(4, 3, ['item3-1']);

        $this->assertTrue($tree->changeParent(4, 2));
        $this->assertEquals(2, $tree->getParentId(4));
    }
